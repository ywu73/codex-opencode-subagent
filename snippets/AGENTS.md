...
- Models:
  - `opencode_worker_ds_v4_flash` (DS v4 Flash): search, extraction, enumeration, repository mapping, log classification, summaries, and checklists.
  - `opencode_worker_ds_v4_pro` (DS v4 Pro): cross-file impact, root-cause and test-gap analysis, deep review, hotspot scanning, and reverse verification.

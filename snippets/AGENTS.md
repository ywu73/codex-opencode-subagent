...
- Models:
  - `opencode_worker_ds_flash` (DS Flash): search, extraction, enumeration, repository mapping, log classification, summaries, and checklists.
  - `opencode_worker_ds_pro` (DS Pro): cross-file impact, root-cause and test-gap analysis, deep review, hotspot scanning, and reverse verification.
